		...
		public class TileAction
		{
			...
			public void DoAction( AutoTileMap _autoTileMap )
			{
				...
				for( int i = 0; i < aTileData.Count; ++i )
				{
					...
					_autoTileMap.AddAutoTile( tileData.Tile_x, tileData.Tile_y, tileData.Tile_type, tileData.Tile_layer );
			...
			public void UndoAction( AutoTileMap _autoTileMap )
			{
				...
				{
					TileData tileData = aTileData[i];
					_autoTileMap.AddAutoTile( tileData.Tile_x, tileData.Tile_y, tileData.Tile_type_prev, tileData.Tile_layer );
